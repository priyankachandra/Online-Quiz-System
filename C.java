...
if(rs.next())
{
 ...
 count++;
pw.println("<html>");
pw.println("<body background=\"../images/img10.jpg\">");
pw.println("<table><tr>");
...
pw.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp");
pw.println("</h1></div></td>");
if(count==no)
{
   pw.println("<td>");
   pw.println("<form  action=Submit>");
pw.println("<b><button type=submit style=color:white;background-color:maroon;font-weight:bold;font-size:15px;border-radius:10px;width:100px;height:50px;>Submit</button></form></b>");
   pw.println("</td>");
...
pw.println("</tr>");
pw.println("<tr>");
pw.println("<td><input type=radio name=option value="+rs.getString(4)+">");
pw.println(rs.getString(4));
pw.println("</td>");
pw.println("<tr>");
pw.println("<td><input type=radio name=option value="+rs.getString(5)+">");
pw.println(rs.getString(5));
pw.println("</td>");
pw.println("</tr>");
pw.println("<tr>");
pw.println("<td><input type=radio name=option value="+rs.getString(6)+">");
...
if(count<no)
{
pw.println("<form method=get action=C >");
...
{
pw.println("<td>");
pw.println("<form method=Post action=C>");
