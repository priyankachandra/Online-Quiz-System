...
pw.println("<center>");
	 ...
	 pw.println("<form action=Update1>");
	  pw.println("<table>");
	 pw.println("<tr>");
	 pw.println("<td>Enter the language in which u want to update question</td><td><input type=text name=lang><br><br></td></tr>");
	 pw.println("<td>Enter Question no to be updated</td><td><input type=text name=qno><br><br></td></tr>");
	  pw.println("</table>");
